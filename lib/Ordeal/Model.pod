...
get shuffled cards from a deck. L</get_deck> is used to retrieve
the deck of cards using C<$id>.
...
L<Ordeal::Model::ChaCha20>. Possibly that.
...
if L</random_source> above is present in C<%args>.
